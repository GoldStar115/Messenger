...
public class RoundedCornersGaganImageView extends ImageView
{
	...
	public RoundedCornersGaganImageView(Context context)
	{
		super(context);

	}

	public RoundedCornersGaganImageView(Context context , AttributeSet attrs)
	{
		super(context, attrs);

	}

	public RoundedCornersGaganImageView(Context context , AttributeSet attrs , int defStyle)
	{
	...
	public void setImageUrl(Context con, String URL)
	{
		...
		options = new DisplayImageOptions.Builder().cacheInMemory(true).cacheOnDisc(true).resetViewBeforeLoading(true).showImageForEmptyUri(R.drawable.no_media).showImageOnFail(R.drawable.no_media)
