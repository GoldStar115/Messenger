...
public class HangoutFriendGroup extends Activity
{
    ...
    class GetGroupsHangoutByFriends extends AsyncTask<String, Void, String>
    {
        ...
        protected String doInBackground(String... params)
        {
            ...
            param.add(new BasicNameValuePair(GlobalConstant.GROUP_USERS_ID, friendID_ ));
                                ...
                                public void onItemClick(AdapterView<?> parent, View view, final int position, long id)
                                {
                                    ...
                                    else
                                    {
                                        GlobalUtills.joinORadd_group =
                                            worldGroupList_.get(position).getUserStatus().equalsIgnoreCase("Y");
        ...
        protected void onPostExecute(String result)
        {
            ...
            try
            {
                ...
                if (messageString_.equalsIgnoreCase(GlobalConstant.SUCCESS))
                {
                    ...
                    Toast.makeText(HangoutFriendGroup.this, messageString_, Toast.LENGTH_LONG).show();
            }
            catch (Exception e)
            {
                e.printStackTrace();
