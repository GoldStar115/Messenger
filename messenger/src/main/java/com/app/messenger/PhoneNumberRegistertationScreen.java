...
public class PhoneNumberRegistertationScreen extends Activity
{
    ...
    public class RegisterUser extends AsyncTask<Void, Void, String>
    {
        ...
        protected String doInBackground(Void... params)
        {
            ...
            param.add(new BasicNameValuePair(GlobalConstant.U_TYPE,    "registerup"));
        ...
        protected void onPostExecute(String result)
        {
            ...
            try
            {
                ...
                if (successMessageString.equalsIgnoreCase(GlobalConstant.FAILURE))
                {
                ...
                {
                    progressDialog_.dismiss();
                    if (jsonObject.has(GlobalConstant.JOIN_USER_ID))
                    {
                        GlobalUtills.user_id  = jsonObject.getString(GlobalConstant.JOIN_USER_ID);
                        GlobalUtills.email_id = jsonObject.getString("user_email");

                        global_.setUser_id(jsonObject.getString(GlobalConstant.JOIN_USER_ID));
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        buttonLogin_.setOnClickListener(new OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                if (!globalUtills_.haveNetworkConnection(PhoneNumberRegistertationScreen.this))
                    GlobalUtills.showToast(GlobalConstant.ERROR_NO_NETWORK_CONNECTION, PhoneNumberRegistertationScreen.this);
        ...
        spnCountryName.setAdapter(new ArrayAdapter<>(PhoneNumberRegistertationScreen.this, R.layout.spinner_layout,
                                                           listCountryName_));
